...
const KNOWN_SITES: { match: string[]; label: string }[] = [
  ...
  { match: ["vidara"], label: "vidara" },
  { match: ["odysseusa"], label: "odysseusa" },
  { match: ["mixdrop", "miiiixdrop"], label: "mixdrop" },
  { match: ["streamtape"], label: "streamtape" },
  { match: ["doodstream", "dood.so", "dood."], label: "doodstream" },
  {
    match: ["streamwish", "swhoi", "filelions", "filelion", "embedwish"],
    label: "streamwish",
  },
